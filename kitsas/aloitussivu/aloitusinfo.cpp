...
AloitusInfo::AloitusInfo(const QString &luokka, const QString &otsikko, const QString &teksti, const QString &linkki, const QString kuva, const QString ohjelinkki) :
    luokka_{luokka}, otsikko_{otsikko}, teksti_{teksti}, linkki_{linkki}, kuva_{kuva}, ohjelinkki_{ohjelinkki}
{
