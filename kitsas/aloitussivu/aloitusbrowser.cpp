...
{
    if( tilioimatta_ ) {
        vinkkaa("tilioimatta",tr("Tiliöinti on kesken %1 tiliotteessa. Kirjanpitosi ei täsmää ennen kuin nämä tositteet on tiliöity loppuun saakka.").arg(tilioimatta_),
