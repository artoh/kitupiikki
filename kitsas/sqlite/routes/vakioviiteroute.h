...
*/
#ifndef VAKIOVIITEROUTE_H
#define VAKIOVIITEROUTE_H

#include "../sqliteroute.h"

class VakioviiteRoute : public SQLiteRoute
{
public:
    VakioviiteRoute(SQLiteModel *model);
...
private:
    QString seuraavaViite() ;

};

#endif // VAKIOVIITEROUTE_H
