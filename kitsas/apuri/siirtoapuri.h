...
public:
    ...
    void laskuMaksettu(const QDate& pvm, const QString& otsikko, const int tili, const EraMap& era, const QVariantMap& kumppani, const Euro& euro, bool debet, const int vastatili);
