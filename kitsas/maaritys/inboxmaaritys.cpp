    ...
    ui_(new Ui::InboxMaaritys)
{
    ...
    connect( ui_->poistaNappi, &QPushButton::clicked, this,  [this] { emit this->tallennaKaytossa(this->onkoMuokattu()); });
    connect( ui_->kopioNappi, &QPushButton::clicked, this, &InboxMaaritys::valitseKopioKansio);
    connect( ui_->kopioRadio, &QPushButton::clicked, this, [this] { emit this->tallennaKaytossa(this->onkoMuokattu()); });
    connect( ui_->poistaRadio , &QPushButton::clicked, this, [this] { this->ui_->kopioEdit->clear(); emit this->tallennaKaytossa(this->onkoMuokattu());});
}
