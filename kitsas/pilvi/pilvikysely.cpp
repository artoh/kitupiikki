...
void PilviKysely::verkkovirhe(QNetworkReply::NetworkError koodi)
{
    if( koodi == QNetworkReply::ConnectionRefusedError)
        ...
        emit kp()->onni(tr("<b>Yhteys katkesi</b><br>Syynä voi olla suuri samanaikaisten pyyntöjen määrä palvelimelle. <br>Yritä uudelleen hetken kuluttua."), Kirjanpito::Verkkovirhe);
