 ...
 */
class VanhaLaskuDialogi : public QDialog, public Esikatseltava
{
    Q_OBJECT
public:

    VanhaLaskuDialogi(const QVariantMap& data = QVariantMap(), bool ryhmalasku = false, int asiakas = 0);
    ~VanhaLaskuDialogi() override;
