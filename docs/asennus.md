...
!!! danger "Ohjelma on vielä kehitysvaiheessa"
    Ohjelmassa on vielä virheitä ja puutteita. Toimintoihin ja tilikarttoihin tulee muutoksia ennen vakaan 1.0-version julkaisua. Beta-versiot jaetaan ensisijaisesti testikäyttöön, käyttäminen varsinaiseen kirjanpitoon ei ehkä ole vielä suositeltavaa.
...
!!! note ""
    ...
    <span class="fa fa-windows"></span> [Kitupiikki 0.6 beta Windows asennusohjelma (21 MB)](https://github.com/artoh/kitupiikki/releases/download/v0.6.0-beta/kitupiikki0.6-beta-asennus.exe) Kehitysvaiheessa oleva ohjelma, virheet ja puutteet vielä todennäköisiä
...
!!! note ""
    <span class="fa fa-linux"></span> [Kitupiikki 0.6 beta Linux AppImage (34 MB)](https://github.com/artoh/kitupiikki/releases/download/v0.6.0-beta/Kitupiikki-0.6-beta-x86_64.AppImage)
