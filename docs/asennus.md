...
!!! note ""
    <span class="fa fa-windows"></span> [Kitupiikki 1.3.2 Windows asennusohjelma (11 MB)](https://github.com/artoh/kitupiikki/releases/download/v1.3.2/kitupiikki-1.3.2-asennus.exe) <i class="fa fa-laptop"></i> Lataa ja suorita asennusohjelma. <i class="fa fa-user"></i> Vaatii pääkäyttäjän oikeudet.

     <span class="fa fa-windows"></span> [Kitupiikki 1.3.2 Windows suoritettava ohjelma (14 MB)](https://github.com/artoh/kitupiikki/releases/download/v1.3.2/kitupiikki-1.3.2.exe) <i class="fa fa-briefcase"></i> Käynnistettävissä ilman asennusta esim. USB-muistilta.
...
!!! note ""
    <span class="fa fa-linux"></span> [Kitupiikki 1.3.2 Linux AppImage (34 MB)](https://github.com/artoh/kitupiikki/releases/download/v1.3.2/Kitupiikki-1.3.2-x86_64.AppImage)
...
!!! note ""
    <span class="fa fa-apple"></span> [Kitupiikki 1.3.2 macOS asennuspaketti (17 MB) ](https://github.com/petriaarnio/kitupiikki/releases/download/mac_v1.3.2/Kitupiikki-1.3.2.dmg)  
