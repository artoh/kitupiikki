...
VanhaArkistoija::VanhaArkistoija(Tilikausi tilikausi)
    : tilikausi_(tilikausi)
{
}

void VanhaArkistoija::luoHakemistot()
{
    QDir hakemisto;
...
void VanhaArkistoija::arkistoiTositteet()
{
/*
...
void VanhaArkistoija::kirjoitaIndeksiJaArkistoiRaportit()
{
...
void VanhaArkistoija::arkistoiTiedosto(const QString &tiedostonnimi, const QString &html)
{
...
void VanhaArkistoija::arkistoiByteArray(const QString &tiedostonnimi, const QByteArray &array)
{
    QFile tiedosto( hakemisto_.absoluteFilePath(tiedostonnimi));
    tiedosto.open( QIODevice::WriteOnly);
...
void VanhaArkistoija::kirjoitaHash()
{
...
QString VanhaArkistoija::navipalkki(int edellinen, int seuraava)
{
...
QString VanhaArkistoija::arkistoi(Tilikausi &tilikausi)
{
    VanhaArkistoija arkistoija(tilikausi);
