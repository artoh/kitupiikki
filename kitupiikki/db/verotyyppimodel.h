...
namespace AlvKoodi {
    ...
    enum Koodi
    {
        ...
        MAAHANTUONTI = 27,
        MAKSUPERUSTEINEN_MYYNTI = 19,
        MAKSUPERUSTEINEN_OSTO = 29,
        ALVKIRJAUS = 100,
        ALVVAHENNYS = 200,
        MAKSUPERUSTEINEN_KOHDENTAMATON = 400,
        MAKSUPERUSTEINEN_VELKA = 401,
        MAKSUPERUSTEINEN_SAATAVA = 402,
        KOHDENTAMATON_MYYNTI = 419,
        KOHDENTAMATON_OSTO = 429,
        MAKSETTAVAALV = 900
    };
